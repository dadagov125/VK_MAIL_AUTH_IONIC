  ...
  if (!VK.Auth) {
    VK.Auth = {
      ...
      login: function (cb, settings) {
        ...
        var url = VK._domain.main + VK._path.login + '?client_id=' + VK._apiId + '&display=touch&redirect_uri=close.html&response_type=token';
  ...
  VK.UI = {
    ...
    popup: function (options) {
      ...
      VK.UI.active.addEventListener('loadstop', function (event) {
        ...
        if (url == 'https://oauth.vk.com/close.html') {

          var url = 'https://login.vk.com/?act=openapi&oauth=1&aid=' + parseInt(VK._apiId, 10) + '&location=localhost';
